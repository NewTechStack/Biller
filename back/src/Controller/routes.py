...
def setuproute(app, call):
    ...
    @app.route('/client/<>/folder/<>/bill/<>',          ['OPTIONS', 'PUT'],           lambda x = None: call([sso_verify_token, client_set_by_id, client_exist, folder_set_by_id, folder_exist, bill_set_by_id, bill_exist, bill_status_0, bill_edit])       )
    @app.route('/client/<>/folder/<>/bill/<>',          ['OPTIONS', 'DELETE'],        lambda x = None: call([sso_verify_token, client_set_by_id, client_exist, folder_set_by_id, folder_exist, bill_set_by_id, bill_exist, bill_status_0, bill_delete])     )
