...
def setuproute(app, call):
    ...
    @app.route('/bank',                                ['OPTIONS', 'POST'],          lambda x = None: call([sso_verify_token, bank_new, bank_edit])                                                                                                    )
    ...
    @app.route('/v2/reports', ['OPTIONS', 'post'],     lambda x = None: call([sso_verify_token, report_get]))
